...
public:
  ...
  MyGLApp() :
  GLApp(800, 600, 1, "Solution 13 - Deferred Shadows"),
  ...
  void updateState() {
    ...
    worldToShadowMatrix = clipToTextureMatrix * lightProjectionMatrix * lightViewMatrix;
    viewToShadowMatrix = worldToShadowMatrix * Mat4::inverse(viewMatrix);
  }
  ...
  void renderDeferredImage() {
    ...
    pDeferred.setUniform("viewToShadow", viewToShadowMatrix);
    ...
    pDeferred.setTexture("shadowMap", shadowMap, 4);
  ...
  virtual void draw() override {
    ...
    shadowFramebuffer.bind(shadowMap);
  ...
  void setupGeometry() {
    ...
    planeArray.connectVertexAttrib(planePosBuffer, pShadow, "vertexPosition", 3);
    ...
    teapotArray.connectVertexAttrib(teapotPosBuffer, pShadow, "vertexPosition", 3);
